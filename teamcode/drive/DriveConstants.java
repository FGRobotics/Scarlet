...
public class DriveConstants {
    ...
    //getMotorVelocityF(MAX_RPM / 60 * TICKS_PER_REV) for f
     ...
     * empirically tuned.
     */
    public static double kV = 0.01307620297185485;
    public static double kA = 0.005;
    public static double kStatic = 0.0176;
    ...
    public static double MAX_ANG_VEL = 2.8404;//Math.toRadians(184)
